...
const Alumni = () => {
  const members = [
    ...
    { 
      name: 'Anshika', 
      post: 'General Secretary (2025-26)', 
      image: anshikaImg,
    ...
    { 
      name: 'Swapnil Ghosh', 
      post: 'Assistant General Secretary (2025-26)', 
      image: swapnilImg,
    ...
    { 
      ...
      post: 'Graphic Design head (2025-26)',
    ...
    { 
      ...
      post: 'Head Web Development (2025-26)', 
      image: dharmanaImg,
    ...
    { 
      name: 'Supriyo Mondal', 
      post: 'Alumni affairs head (2025-26)', 
    ...
    { 
      name: 'Ongwec Hudson', 
      post: 'Senior Event Manager (2025-26)', 
      image: hudsonImg,
